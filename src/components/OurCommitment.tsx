        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-5 md:gap-6 lg:gap-8">
          {commitments.map((item, index) => (
            <motion.div
              ...
              className="corporate-card cardboard-shadow-flat rounded-xl p-4 sm:p-6 md:p-8 !flex !flex-col items-center justify-start text-center !bg-gray-100 dark:!bg-zinc-800 dark:!border-zinc-700 transition-colors duration-500"
            >
